...
if (isset($_SESSION['session_username'])) {
    ...
    <body class="bgadmin">
        ...
        <img src="../img/admin.png" alt="" style="height:100; padding-left:500; margin-top:50"> <center><div style="margin-top:-50; font-size:20px; font-family:Franklin Gothic Medium; color: white">Welcome, Admin!</div></center>
